...
from libs.convertqtimage import ConvertQImage
import math
...
class Canvas(QWidget):
    ...
    # add by yuan
    def saveSplitImage(self, shape, split_img, ismask, serial_num):
        ...
        #self.fileName
        if ismask:
            img_file = '{}_{}_mask.jpg'.format(label_name, serial_num)
        else:
            img_file = '{}_{}.jpg'.format(label_name, serial_num)
    ...
    def saveSelectedShape(self):
        ...
        if shape.drawRegion:
            ...
            self.saveSplitImage(shape, split_img, False, str_time)
    ...
    def saveRegionByOutsideRectangle(self, shape, rectangle, str_time):
        ...
        print ('save image')
        self.saveSplitImage(shape, pix, True, str_time)
        print('end - ')
