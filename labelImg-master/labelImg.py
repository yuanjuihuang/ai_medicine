...
__appname__ = "AI Medicne For Breast " #'labelImg'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        # yuan add region struct to here and add region to onLoadActive and beginnerContext
        self.actions = struct(save=save, save_format=save_format, saveAs=saveAs, open=open, close=close, resetAll=resetAll,
                              lineColor=color1, create=create, region=region, splitimg=splitimg, delete=delete, edit=edit, copy=copy,
        ...
        addActions(self.menus.file, (open, save, saveAs, close, quit))
        """
        ...
        self.actions.beginner = (open, save, None, create, region, delete, None )
    ...
    def loadLabelsWithRegion(self, shapes):
        s = []
        for label, points, line_color, fill_color, difficult, drawRegion in shapes:
            shape = Shape(label=label)
            shape.drawRegion = drawRegion
